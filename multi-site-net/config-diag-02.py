...
as100_net0 = as100.createNetwork('net0', '172.16.100.0/24')
...
as201_net0 = as201.createNetwork('net-201-0', '10.10.0.0/24')
as201_net1 = as201.createNetwork('net-201-1', '10.10.1.0/24')
...
as201_r1.joinNetwork('net-201-0', "10.10.0.2")
as201_r1.joinNetwork('net-201-1', "10.10.1.2")
as201_r2.joinNetwork('net-201-0', "10.10.0.3")
as201_r2.joinNetwork('net-201-1', "10.10.1.3")

# Generate keepalived.conf content for each router
r1_conf  = generate_keepalived_conf("MASTER", "net-201-0", 51, 200, "10.10.0.1/24")
r2_conf  = generate_keepalived_conf("BACKUP", "net-201-0", 51, 100, "10.10.0.1/24")
r1_conf += generate_keepalived_conf("MASTER", "net-201-1", 52, 200, "10.10.1.1/24")
r2_conf += generate_keepalived_conf("BACKUP", "net-201-1", 52, 100, "10.10.1.1/24")
...
as202_net0 = as202.createNetwork('net-202-0', '10.10.2.0/24')
as202_net1 = as202.createNetwork('net-202-1', '10.10.3.0/24')
...
as202_r1.joinNetwork('net-202-0', "10.10.2.2")
as202_r1.joinNetwork('net-202-1', "10.10.3.2")
as202_r2.joinNetwork('net-202-0', "10.10.2.3")
as202_r2.joinNetwork('net-202-1', "10.10.3.3")

# Generate keepalived.conf content for each router
r1_202_conf  = generate_keepalived_conf("MASTER", "net-202-0", 53, 200, "10.10.2.1/24")
r2_202_conf  = generate_keepalived_conf("BACKUP", "net-202-0", 53, 100, "10.10.2.1/24")
r1_202_conf += generate_keepalived_conf("MASTER", "net-202-1", 54, 200, "10.10.3.1/24")
r2_202_conf += generate_keepalived_conf("BACKUP", "net-202-1", 54, 100, "10.10.3.1/24")
...
as203_r1   = as203.createRouter('r1')
as203_r1.joinNetwork('net-203-0')
...
as201_r1.crossConnect(100, 'r1', '10.50.0.1/30')
as100_r1.crossConnect(201, 'r1', '10.50.0.2/30')

# as201_r2 to as100_r2
as201_r2.crossConnect(100, 'r2', '10.50.0.5/30')
as100_r2.crossConnect(201, 'r2', '10.50.0.6/30')

# as202_r1 to as100_r1
as202_r1.crossConnect(100, 'r1', '10.50.0.9/30')
as100_r1.crossConnect(202, 'r1', '10.50.0.10/30')

# as202_r2 to as100_r2
as202_r2.crossConnect(100, 'r2', '10.50.0.13/30')
as100_r2.crossConnect(202, 'r2', '10.50.0.14/30')

# as203_r1 to as100_r3
as203_r1.crossConnect(100, 'r3', '10.50.0.17/30')
as100_r3.crossConnect(203, 'r1', '10.50.0.18/30')

# as204_r1 to as100_r3
as204_r1.crossConnect(100, 'r3', '10.50.0.21/30')
as100_r3.crossConnect(204, 'r1', '10.50.0.22/30')

# as204_r1 to as100_r4
as204_r1.crossConnect(100, 'r4', '10.50.0.25/30')
as100_r4.crossConnect(204, 'r1', '10.50.0.26/30')

# as205_r1 to as100_r3
as205_r1.crossConnect(100, 'r4', '10.50.0.29/30')
as100_r4.crossConnect(205, 'r1', '10.50.0.30/30')
...
as201_r1.appendStartCommand('/etc/init.d/keepalived start')
as201_r2.appendStartCommand('/etc/init.d/keepalived start')
